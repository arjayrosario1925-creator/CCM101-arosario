...
In this activity, I learned how to set up an object storage server with Docker. I also practiced using the MinIO Web Console, creating a storage bucket, and uploading files. Aside from that, I gained a better understanding of the differences between Block Storage, File Storage, and Object Storage. I also improved my skills in writing and organizing technical documentation using Markdown.
